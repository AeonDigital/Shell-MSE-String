...
#
# @example
#   mse_str_convertDecimalToHex "161"       # converte para -> A1
#   mse_str_convertDecimalToHex "195 173"   # converte para -> "C3 AD"
#   result=$(mse_str_convertDecimalToHex "161" 1)
mse_str_convertDecimalToHex() {
