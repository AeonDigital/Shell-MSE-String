...
#
# @example
#   mse_str_convertOctalToDecimal "241"       # converte para -> 161
#   mse_str_convertOctalToDecimal "303 255"   # converte para -> "195 173"
#   result=$(mse_str_convertOctalToDecimal "241" 1)
mse_str_convertOctalToDecimal() {
