...
#
# @example
#   mse_str_convertHexToOctal "A1"      # converte para -> 241
#   mse_str_convertHexToOctal "C3 AD"   # converte para -> "303 255"
#   result=$(mse_str_convertHexToOctal "A1" 1)
mse_str_convertHexToOctal() {
